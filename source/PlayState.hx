...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else if (SONG.song.toLowerCase() == 'geometry' || SONG.song.toLowerCase() == 'void' || SONG.song.toLowerCase() == 'philly')
		{
			curStage = 'philly';
		...
		else if (SONG.song.toLowerCase() == 'cocoa' || SONG.song.toLowerCase() == 'chipsong')
		{
			curStage = 'mall';
	...
	function endSong():Void
	{
		...
		if (isStoryMode)
		{
			...
			if (storyPlaylist.length <= 0)
			{
				...
				// if ()
				StoryMenuState.weekUnlocked[Std.int(Math.min(storyWeek + 1, StoryMenuState.weekUnlocked.length - 1))] = false;
			...
			else
			{
				...
				if (SONG.song.toLowerCase() == 'chipsong')
				{
