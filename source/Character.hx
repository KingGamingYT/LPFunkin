	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 18);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 18);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 18);
				animation.addByPrefix('singDOWN', 'Dad Sing Note DOWN', 18);
				animation.addByPrefix('singLEFT', 'Dad Sing Note LEFT', 18);

				addOffset('idle');
				addOffset("singUP", -6, 0);
				addOffset("singRIGHT", -15, -1);
				addOffset("singLEFT", -10, 0);
				addOffset("singDOWN", -30, -14);
			...
			case 'spirit':
				...
				addOffset('idle', -220, -322);
				addOffset('singUP', -220, -310);
				addOffset("singRIGHT", -220, -311);
				addOffset("singLEFT", -200, -310);
				addOffset("singDOWN", -296, -310);
